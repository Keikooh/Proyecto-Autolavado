        ...
        <main>
            ...
            <form id="frmFiltrador" class="mb-8" action="admin" method="post">
                <div class="flex justify-between items-center">
                    ...
                    <h2 class="text-[#001459] text-base font-bold mr-8">Herramientas de Filtrado</h2>
                    </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody id="tResultado"class="bg-white divide-y divide-gray-200">
                    <?php echo $resultado ?>
                </tbody>
            </table><br>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody id="tEmpleados"class="bg-white divide-y divide-gray-200">
                ...
                $('#frmFiltrador :input').on('input', function(e) {
                    ...
                    $.post("accionesAdmin",{
                        ...
                        try {
                            ...
                            $("#tResultado").html(resultado);
                            $("#tEmpleados").html(empleado);
                        } catch (error) {
